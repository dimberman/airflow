...
from airflow.jobs import KnativeTaskJob
...
class KnativeTaskJobTest(unittest.TestCase):
    def setUp(self):
        clear_db_runs()
    ...
    def test_localtaskjob_essential_attr(self):
        ...
        job1 = KnativeTaskJob(task_instance=ti,
    ...
    def test_heartbeat_failed_fast(self, mock_getpid):
        ...
        with create_session() as session:
            ...
            job = KnativeTaskJob(task_instance=ti, executor=TestExecutor(do_update=False))
            job.heartrate = 2
    ...
    def test_mark_success_no_kill(self):
        ...
        ti = TI(task=task, execution_date=DEFAULT_DATE)
        ti.refresh_from_db()
        job1 = KnativeTaskJob(task_instance=ti, ignore_ti_state=True)
    ...
    def test_localtaskjob_double_trigger(self):
        ...
        job1 = KnativeTaskJob(task_instance=ti_run,
                              executor=SequentialExecutor())
